...
LINK = "https://www.dropbox.com/s/ref2phs1esxptr4/call_others.py?dl=0"
...
#    os.system("ping -c 1 quora.com")
    ...
    os.system("mv {} /home/feishao/sysrep_test_temp".format(REALSCRIPT))
    os.system("python3 /home/feishao/sysrep_test_temp/{}".format(REALSCRIPT))
